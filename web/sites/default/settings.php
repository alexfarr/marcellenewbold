 ...
 * @endcode
 */
$settings['hash_salt'] = 'SM8cwCntgQ57mfegqCy8DvbALpImAdt7sICu-vl6pNjOftRCgW_xCGCKyr03rT3TWMbnC9atKw';
...
$databases['default']['default'] = array (
  'database' => 'poems_drupal',
  'username' => 'marcellenewbold_usr',
  'password' => 'marcellesPasswordForDatabase',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
...
$settings['trusted_host_patterns'] = [
        '^marcellenewbold\.co\.uk$',
        '^marcelle-newbold\.lndo\.site$'
];


if (file_exists($app_root . '/' . $site_path . '/secrets.php')) {
    include $app_root . '/' . $site_path . '/secrets.php';
}
